...
function addAPI(username, service, tokens, callback){
  ...
  switch(service){
    case "YouTube":
      ...
      break;
    case "Twitch":
      data = {"$set":{"APIs.Twitch" : newTokens}, "$addToSet": {"exists": "Twitch"}};
      break;
    case "Netflix":
      data = {"$set":{"APIs.Netflix" : newTokens}, "$addToSet": {"exists": "Netflix"}};
      break;
    case "HBOGo":
      data = {"$set":{"APIs.HBOGo" : newTokens}, "$addToSet": {"exists": "HBOGo"}};
      break;
    case "Amazon":
      data = {"$set":{"APIs.Amazon": newTokens}, "$addToSet": {"exists": "Amazon"}};
      break;
    default:
