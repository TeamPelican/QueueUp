...
var team = [
	member('nfuller', 'Nathan', 'Fuller', 'senior'),
	member('dlaizer', 'Dan', 'Laizer', 'senior'),
	member('abradley', 'Adam', 'Bradley', 'junior'),
	member('cgiang', 'Co', 'Giang', 'unknown'),
	member('zhili', 'Zhi', 'Li', 'unknown'),
	member('kfarr', 'Kevin', 'Farr', 'senior')
];
 ...
 */
function copy(mem) {
	return member(mem.user, mem.fname, mem.lname, mem.year)
}
